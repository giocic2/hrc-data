...
# ANALYSIS SETTINGS
SAMPLING_FREQUENCY = 10e3 # According to "hrc-ps.py" script
FFT_RESOL = 1 # Hz
ACQUISITION_TIME = 0.5 # s
...
filename_IF = None
while filename_IF == None:
    filename_IF = easygui.fileopenbox(title = "Choose IFI *.csv file...", default = "*.csv")
print(filename_IF)

rawSamples_IF = np.genfromtxt(filename_IF, delimiter = ',')

voltageAxis_IFI_mV = rawSamples_IF[3:,1]
voltageAxis_IFQ_mV = rawSamples_IF[3:,2]
